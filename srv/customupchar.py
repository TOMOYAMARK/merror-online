...
# 画像を生成する
num_generate =50	# 生成する画像の数

#ベクトルの元データを取得(addition)
org_vector = []
f = codecs.open('baseVecs.txt','r','utf8')
line = f.readline()
while line:
...
for i in range(100):
	tgt_vector[i] = (add_vector[0] * (1-(i*delta))) + (org_vector[0] * (i*delta))
...
for i in range(100):
	...
	himg.save('gens/result-' + str(i) + '.png')
